                            ...
                            <li class="item" id="{{$item->category->slug}}">
                                ...
                                <a href="#">
                                    <img src="{{asset('uploads/item/'.$item->image)}}" class="img-responsive" alt="Item"
                                         style="height: 400px; max-width:max-content    ">
                                ...
                                <h2 class="white">{{$item->price}} đ</h2>
                            </li>
                        @endforeach
                    </ul>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, 2019 <a href="#">Fooday</a>Developed by <a href="https://github.com/thaoluc">Zelda Luc</a>
